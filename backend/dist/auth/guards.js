...
exports.RolesGuard = exports.OptionalJwtAuthGuard = exports.JwtAuthGuard = void 0;
...
let RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        if (!hasRole) {
            throw new common_1.ForbiddenException(`Role '${user.role}' is not authorized. Required: ${requiredRoles.join(' or ')}`);
        }
        return true;
    }
};
